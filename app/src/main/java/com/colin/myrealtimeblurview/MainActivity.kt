package com.colin.myrealtimeblurview
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadImage(){
        ...
        GlideImageLoader.getInstance().displayWithBlurRound(this,defaultUrl,20,1000)?.resetScaleType(
            ScaleTypeMenu.CenterCrop)?.intoTargetView(iv_defalult_blur_circle)
    }
    ...
    private fun bindListener(){
        ...
        tv_process?.setOnClickListener {
            tv_process?.text="0%"
            GlideImageLoader.getInstance().displayWithDrawable(this,defaultUrl5,object :
                OnProgressListener<Drawable> {
        ...
        tv_getUrl_process?.setOnClickListener {
            ...
            GlideImageLoader.getInstance().getUrlWithBitmap(this,defaultUrl6,object :
                OnProgressListener<Bitmap> {
                override fun onProgress(
                    isComplete: Boolean,
                    percentage: Int,
                    bytesRead: Long,
        ...
        blur_radius.setProgress(10)
        blur_radius.setOnSeekBarChangeListener(
